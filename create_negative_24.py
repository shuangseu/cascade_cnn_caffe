...
save_dir_neg = '/home/gavinpan/workspace/face_data/neg/neg_51'  # file to save patches
...
MODEL_FILE = '/home/gavinpan/workspace/CNN_face_detection_models/face_12c/face12c_full_conv.prototxt'
PRETRAINED = '/home/gavinpan/workspace/CNN_face_detection_models/face_12c/face12c_full_conv_soft_quantize_2.caffemodel'
#MODEL_FILE = '/home/anson/caffe-master/models/face_12c/face12c_full_conv.prototxt'
#PRETRAINED = '/home/gavinpan/workspace/cascade_cnn/12_net/12_net_snapshot/_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
for current_picture in range(0, number_of_pictures):
    ...
    for cur_rectangle in rectangles:
        ...
        save_image_name = save_dir_neg + '/neg51_' + str(save_image_number).zfill(6) + '.jpg'
