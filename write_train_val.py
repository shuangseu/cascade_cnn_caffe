...
# =================== face_12c =================================
if trainingNet == 12:
    pos_file_name = 'all_positives.txt'
    neg_file_name = 'all_negatives_12.txt'
    train_file_name = './12_net/train_12'
    val_file_name = './12_net/val_12'
    write_train_name = './12_net/train_12.txt'
    write_train = open(write_train_name, "w")
    write_val_name = './12_net/val_12.txt'
    write_val = open(write_val_name, "w")

# =================== face_24c =================================
elif trainingNet == 24:
    pos_file_name = 'all_positives.txt'
    neg_file_name = 'all_negatives_24c.txt'
    train_file_name = './24_net/train_24'
    val_file_name = './24_net/val_24'
    write_train_name = './24_net//train_24.txt'
    write_train = open(write_train_name, "w")
    write_val_name = './24_net//val_24.txt'
    write_val = open(write_val_name, "w")
...
for current_image in range(1000):
    ...
    image_file_name = val[current_image][46:-3]     # retrieve image file name
...
for current_image in range(number_of_train_data):
    ...
    image_file_name = train[current_image][46:-3]     # retrieve image file name
