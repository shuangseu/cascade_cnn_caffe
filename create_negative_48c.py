...
neg_database = '/home/gavinpan/workspace/Face_detection/bg/'    # directory containing negative images
save_dir_neg = '/home/gavinpan/workspace/face_data/neg/neg_52'  # file to save patches
suspicious_dir = '/home/gavinpan/workspace/face_data/susp'
...
# ==================  caffe  ======================================
caffe_root = '/home/gavinpan/workspace/caffe-master/'  # this file is expected to be in {caffe_root}/examples
import sys
...
MODEL_FILE = '/home/gavinpan/workspace/CNN_face_detection_models/face_12c/deploy.prototxt'
PRETRAINED = '/home/gavinpan/workspace/CNN_face_detection_models/face_12c/face_12c_train_iter_400000.caffemodel'
...
# Set the right path to your model definition file, pretrained model weights,
# and the image you would like to classify.
MODEL_FILE = '/home/gavinpan/workspace/CNN_face_detection_models/face_12_cal/deploy.prototxt'
PRETRAINED = '/home/gavinpan/workspace/CNN_face_detection_models/face_12_cal/face_12_cal_train_iter_370000.caffemodel'
caffe.set_mode_gpu()
...
# Set the right path to your model definition file, pretrained model weights,
# and the image you would like to classify.
MODEL_FILE = '/home/gavinpan/workspace/CNN_face_detection_models/face_24c/deploy.prototxt'
PRETRAINED = '/home/gavinpan/workspace/CNN_face_detection_models/face_24c/face_24c_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
# Set the right path to your model definition file, pretrained model weights,
# and the image you would like to classify.
MODEL_FILE = '/home/gavinpan/workspace/CNN_face_detection_models/face_24_cal/deploy.prototxt'
PRETRAINED = '/home/gavinpan/workspace/CNN_face_detection_models/face_24_cal/face_24_cal_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
